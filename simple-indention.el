;;; simple-indention.el --- Simplify writing indentation functions, alternative to SMIE  -*- lexical-bindings: t -*-
...
(cl-defmacro simple-indention-define-for-major-mode ;nofmt
    (major-mode
     &optional namespace
     &key
       rules
        ...
        `(progn
             ...
             (simple-indention-namespace-defun
              ...
              (let* ((line (simple-indention-utils-current-line))
                     (cursor 0)
                     (oi
                      (simple-indention-namespace-var ,namespace
                                                      one-indent))
                     (step (length oi)))
...
(defun simple-indention-increment-indent-level (&optional n)
    ...
    (setq n (or n 1))
    (--dotimes n
        (funcall simple-indention-increment-indent-level-function)))
...
`N` defaults to 1."
    ...
    (setq n (or n 1))
    (--dotimes n
        (funcall simple-indention-decrement-indent-level-function)))
